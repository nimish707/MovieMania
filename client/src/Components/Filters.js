...
function Filters() {
    ...
    return (
        <div className='my-6 bg-dry border text-dryGray border-gray-800 grid md:grid-cols-4 grd-cols-2 lg:gap-12 gap-2  rounded p-6'>
            {Filter.map((item, index) => (
                <Listbox key={index} value={item.value} onChange={item.onChange}>
                    <div className='relative'>
                        ...
                        <Transition as={Fragment} leave="transition ease-in duration-100" leaveForm="opacity-100" leaveto="opacity-0">
